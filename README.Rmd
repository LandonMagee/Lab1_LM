...
First, lets create a data set of only the used locations
```{r, cougar6}
...
# output is a file name; need to have it or similar named file to save
...
# different way to look at above
...
```{r, obj7}
terra::writeRaster(deer_w, "Output/new_deer.tiff", filetype = "GTiff", overwrite=TRUE)
```
